...
class BaseComp
{
	protected:
	// ================================ ATTRIBUTES
		id_t _id; //  NOTE : if the ID is 0, the component is not supposed to be in CompManager's map
	...
	// ================================ CONSTRUCTORS / DESTRUCTORS
		...
		inline BaseComp( bool isActive, id_t id = 0) : _id( id ), _active( isActive ){ onAdd(); }
